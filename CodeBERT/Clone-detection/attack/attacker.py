...
class Style_Attacker():
    ...
    def style_attack(self, code_pair, true_label, example, adv_codes, query_times, total_adv_codes):
        code_2 = code_pair[3]
        code_2 = " ".join(code_2.split())
        words_2 = self.tokenizer_mlm.tokenize(code_2)
        ...
        for adv_code in adv_codes:
            ...
            if tmp_code.strip() in total_adv_codes.keys():
                ...
                tmp_code_ = self.tokenizer_tgt.tokenize(tmp_code)
                tmp_feature = convert_examples_to_features(tmp_code_, words_2, true_label, None, None, self.tokenizer_tgt, self.args, None)
        ...
        for adv_code1 in adv_codes1:
            ...
            if tmp_code1.strip() in total_adv_codes.keys():
                ...
                tmp_code1_ = self.tokenizer_tgt.tokenize(tmp_code1)
                tmp_feature1 = convert_examples_to_features(tmp_code1_, words_2, true_label, None, None, self.tokenizer_tgt, self.args, None)
