...
def main():
    ...
    for index, example in tqdm(enumerate(eval_examples), total=len(eval_examples)):
        ...
        if 1 == 1:
            ...
            if len(adv_codes) == 0:
                recoder1.write('-1', code, code, ref_summary, pre_summary,
                               pre_summary, round((time.time() - start_time) / 60, 2))
                continue
            total_cnt += 1
            ...
            for adv_code in adv_codes:
                ...
                pred = attacker.eval_bleu(new_example[0])
                query_times += 1
                ...
                if pred[0] == 0.0:
                    ...
                    recoder1.write(is_success, code, adv_code, ref_summary, pre_summary,
                                   pred[1], round((time.time() - start_time) / 60, 2))
                    print(
            ...
            if is_success == -1:
                ...
                while True:
                    is_success, final_code, adv_code, adv_summary, query_times = attacker.style_attack(original_bleu, example, adv_codes_attack, query_times)
                ...
                if is_success == 1:
                    ...
                    print("Query times in this attack: ", query_times)
                    success_attack += 1
                    recoder1.write(is_success, code, adv_code, ref_summary,
                                   pre_summary,
                                   adv_summary,
                    ...
                    recoder1.write(is_success, code, final_code, ref_summary,
                                   pre_summary,
                                   adv_summary,
                                   round((time.time() - start_time) / 60, 2))
                    print("Query times in this attack: ", query_times)
