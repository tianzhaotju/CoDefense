...
# 把i++；temp = i这样的语句合并为temp = ++i这样的语句，有多种情况
...
def trans_tree(e, ignore_list=[], instances=None):
    ...
    for item in expr_elems:
        for expr_elem in item:
            ...
            flag, tree_root, new_ignore_list = expr_transform(expr_elem, tree_root, expr_elem_prev_path,
                                                              new_ignore_list)
    ...
    for item in expr_stmt_elems:
        for expr_stmt_elem in item:
            ...
            flag, tree_root, new_ignore_list = expr_stmt_transfrom(expr_stmt_elem, tree_root, expr_stmt_elem_prev_path,
                                                                   new_ignore_list)
