...
class Recorder():
    ...
    def write(self, index, code, adv_code, true_label, orig_label, temp_label, time_cost):
        self.writer.writerow([index,
                              code,
                              adv_code,
                              true_label,
...
class Recorder_style():
    ...
    def write(self, index, code, adv_code, true_label, pre_label, adv_label, time_cost):
        self.writer.writerow([index,
                              code,
                              adv_code,
                              true_label,
...
class Recorder_summary_style():
    ...
    def write(self, index, code, adv_code, ref_summary, pre_summary, adv_summary, time_cost):
        self.writer.writerow([index,
                              code,
                              adv_code,
                              ref_summary,
